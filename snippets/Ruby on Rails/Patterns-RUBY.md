...
# Uso del servicio
result = UserCreationService.create(email: "user@example.com", password: "consultar en local")
...
![PastedGraphics](file:///.attachment/7BBC05FE-C895-4C06-B054-9BBD587F9BFE.png)
