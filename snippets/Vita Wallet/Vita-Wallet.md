...
Access Token: consultar en local
Feed Token: consultar en local
Email token: consultar en local 
```
...
# En emergencias
git clone https://marcelo143:consultar en local@gitlab.com/VitaWallet/alejandra-web.git
```
...
# USERS QA 
santiago+empre@vitawallet.io  # Empresa Chile consultar en local
...
derly+b2b13@vitawallet.io	consultar en local
```
```shell
# ALEJANDRA WEB
